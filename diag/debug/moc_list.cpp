...
static const char qt_meta_stringdata_List[] = {
    "List\0\0changeIt()\0current,previous\0"
    "currentChangeIt(QListWidgetItem*,QListWidgetItem*)\0"
};
...
void List::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->changeIt(); break;
        case 1: _t->currentChangeIt((*reinterpret_cast< QListWidgetItem*(*)>(_a[1])),(*reinterpret_cast< QListWidgetItem*(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject List::staticMetaObject = {
    { &Dialog::staticMetaObject, qt_meta_stringdata_List,
